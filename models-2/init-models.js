...
function initModels(sequelize) {
	...
	// subject.belongsTo(course, { as: "course", foreignKey: "course_id"});
	// course.hasMany(subject, { as: "subject", foreignKey: "course_id"});
	// subject_days.belongsTo(course_days, { as: "course_day", foreignKey: "course_days_id"});
	// course_days.hasMany(subject_days, { as: "subject_days", foreignKey: "course_days_id"});
	// subject_days.belongsTo(course_days, { as: "course_days_course", foreignKey: "course_days_course_id"});
	// course_days.hasMany(subject_days, { as: "course_days_course_subject_days", foreignKey: "course_days_course_id"});
	...
	// subject_days.belongsTo(subject, { as: "subject", foreignKey: "subject_id"});
	// subject.hasMany(subject_days, { as: "subject_days", foreignKey: "subject_id"});
	// rating.belongsTo(subject_days, { as: "subject_day", foreignKey: "subject_days_id"});
	// subject_days.hasMany(rating, { as: "ratings", foreignKey: "subject_days_id"});
	// rating.belongsTo(subject_days, { as: "subject_days_subject", foreignKey: "subject_days_subject_id"});
	// subject_days.hasMany(rating, { as: "subject_days_subject_ratings", foreignKey: "subject_days_subject_id"});
	// rating.belongsTo(subject_days, { as: "subject_days_course_day", foreignKey: "subject_days_course_days_id"});
	// subject_days.hasMany(rating, { as: "subject_days_course_days_ratings", foreignKey: "subject_days_course_days_id"});
	// rating.belongsTo(subject_days, { as: "subject_days_course_days_course", foreignKey: "subject_days_course_days_course_id"});
	// subject_days.hasMany(rating, { as: "subject_days_course_days_course_ratings", foreignKey: "subject_days_course_days_course_id"});
